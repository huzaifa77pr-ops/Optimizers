    ...
    <NavLink
      ...
      className={({ isActive }) =>
        `group relative inline-flex items-center px-3 py-2 rounded-full text-[15px] font-semibold transition
         ${isActive ? "text-slate-950 bg-slate-100" : "text-slate-900/90 hover:text-slate-950 hover:bg-slate-100"}`
      }
          ...
          <div className="lg:hidden border-t border-slate-200 bg-white">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-4">
              <div className="flex flex-col gap-2">
                ...
                >
                  <span>Expertise</span>
                  <span className="text-slate-600">{mobileDrop === "expertise" ? "▴" : "▾"}</span>
                </button>
                ...
                >
                  <span>Platforms</span>
                  <span className="text-slate-600">{mobileDrop === "platforms" ? "▴" : "▾"}</span>
                </button>
                ...
                <Link to="/careers" className="rounded-xl px-4 py-3 font-bold text-slate-900 hover:bg-slate-100" onClick={() => setMobileOpen(false)}>
                  Careers
                </Link>
                <Link to="/about" className="rounded-xl px-4 py-3 font-bold text-slate-900 hover:bg-slate-100" onClick={() => setMobileOpen(false)}>
                  About
                </Link>
