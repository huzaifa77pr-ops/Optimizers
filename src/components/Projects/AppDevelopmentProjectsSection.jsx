// src/components/Projects/AppDevelopmentProjectsSection.jsx
import { appDevelopmentProjects } from "../../data/appDevelopmentProjects";

export default function AppDevelopmentProjectsSection() {
  return (
      ...
      <div className="mx-auto max-w-7xl px-6 py-12 md:py-16">
        ...
        >
          ...
          <p className="mt-4 text-sm md:text-base text-black leading-relaxed">
            High-quality mobile app builds — crafted for smooth UX, clean UI, and reliable performance.
          </p>
        ...
        <div className="mt-10 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {appDevelopmentProjects.slice(0, 6).map((p, idx) => (
            <a
              key={p.id}
              href={p.url}
              target="_blank"
            ...
            >
              ...
              >
                  ...
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <span
                      className="rounded-full border border-black/15 bg-black px-3 py-1 text-[11px] text-white/90
                                 transition-colors duration-300 group-hover:border-rose-300/40 group-hover:text-white"
                    >
                      Open ↗
                    </span>
                  </div>
                ...
                <div
                  ...
                  style={{
                    boxShadow:
                      "inset 0 0 0 1px rgba(244,63,94,0.18), 0 22px 90px rgba(0,0,0,0.22)",
                  }}
                />
              </article>
            </a>
